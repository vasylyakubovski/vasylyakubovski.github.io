...
function drawTasks(){
	...
	tasks.forEach( function(task, index){
		...
		<tr>
			...
			<td>Забрати замовлення у поштовому відділенні.</td>
			<td><b class="lime">Виконано</b></td>
...
function drawTasks(){
	...
	tasks.forEach( function(task, index){
		...
		<tr>
			...
			<td>${task.describe}</td>
			<td>${status}</td>
			<td class="text-center"><button class="btn btn-warning btn-sm" onclick="editTasks(${index})">edit</button></td>
